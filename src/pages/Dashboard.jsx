...
const Dashboard = () => {
  ...
  return (
    <div
      ...
      } min-h-screen p-6 font-poppins transition-colors duration-500`}
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-lg shadow transition flex items-center gap-1 font-medium"
            >
              <FiSun />
        ...
        <form
          ...
          } flex gap-3 mb-6 p-4 rounded-xl shadow-md transition-colors duration-500`}
        >
          <input
            type="text"
            value={title}
          ...
          {todos.map((todo) => {
            ...
            return (
              <motion.div
                ...
                } flex items-center justify-between p-5 rounded-xl shadow hover:shadow-xl transition border-l-4 mb-3 ${
                  status === "Completed"
                    ? "border-green-500"
                    : "border-yellow-400"
                }`}
              >
                ...
                <div className="flex items-center gap-2">
                  {editId === todo.id ? (
                    <button
                      onClick={saveEdit}
                      className="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-md transition flex items-center gap-1 font-medium"
                    >
                      <FiCheck />
                      Save
                    </button>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded-md transition flex items-center gap-1 font-medium"
                      >
                        <FiEdit />
                        Edit
                      </button>
                      <button
                        ...
                        className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md transition flex items-center gap-1 font-medium"
                      >
                        <FiTrash2 />
                        Delete
                      </button>
